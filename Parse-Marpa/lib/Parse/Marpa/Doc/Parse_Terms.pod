...
This section is document is intended
to be read quickly to serve as a reminder to those
who have previously encountered the basic concepts
of parsing.
I put B<defining uses> of terms in boldface, for easy skimming.
If you feel comfortable with parsing terminology,
you may want to skip this document entirely.

If you've never looked into parsing before,
you'll probably find this document a little too terse.
...
These definitions will be consistent with textbook definitions,
but will not be intended to replace them.
The intention here is to focus on the meaning of the term as it applies to Marpa.
...
When this document uses the term B<parsing> in its strict sense, it will
...
As in dealing with bodies of water, the concepts of B<higher> and B<lower>
have the sense opposite to that of the numerical depth values.
