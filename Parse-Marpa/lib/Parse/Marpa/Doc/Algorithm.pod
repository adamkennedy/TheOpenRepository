...
if you left in some of the non-determinism
when you transformed an NFA to LR(0) DFA,
you could use it to guide the Earley recognizer.
...
but it would make the code shorter and better.

What Marpa does, therefore, is to transform the original NFA into a second NFA.
