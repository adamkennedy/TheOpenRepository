...
C<trace_iterations> traces the initialization of, and the interation of,
the parse tree.
...
=item * Run C<show_bocage> and C<show_tree> on the evaluator.
...
=end Parse::Marpa::test_document:
    ...
    print Parse::Marpa::show_earley_sets($recce);
