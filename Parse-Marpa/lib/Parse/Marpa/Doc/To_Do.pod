...
=item * Create a new porcelain interface, along the lines of the Parrot Grammar
Engine and Perl 6 regexes.
...
=item * Eliminate C<Parse::Marpa::Internal::This::grammar>
...
=item * Are there any Parse::Marpa::Read_Only variables?  Eliminate
