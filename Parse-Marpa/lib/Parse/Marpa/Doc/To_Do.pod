...
=item * Create a show_derivation method to show the derivation
once we have a tree?
...
Eliminate maximums and minimums higher than 1.
The matrix is separated yes versus no;
perl5 versus proper separation;
and 0-1, 1-1, 0-*, versus 1-*.
