...
the parse.
The first parse is found with C<Parse::Marpa::Recognizer::initial()>,
and subsequent parses are found with C<Parse::Marpa::Recognizer::next()>.
