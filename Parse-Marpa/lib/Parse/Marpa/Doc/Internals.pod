...
Often these parse criteria have
...
Marpa evaluates the grammar in MBF form for
four reasons.
...
The current position in an or-node does not necessarily
...
And one or-node is created from the start item to initialize
the parse bocage.
...
=end Parse::Marpa::test_document:
    ...
    Tree Node: S5@0-2R0:2[0]; Depth=2; Argc=3
        Rule: e ::= e op . e
        Predecessor: S3@0-1R0:1
        Value: '+'
    Tree Node: S3@0-1R0:1[0]; Depth=3; Argc=3
        Rule: e ::= e . op e
        Cause: S4@0-1L0
