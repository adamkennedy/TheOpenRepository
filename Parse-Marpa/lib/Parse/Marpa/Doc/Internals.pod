...
And in the traditional notation for an Earley item the dot earleme is not
...
and need to be split into nulling and non-nulling
variants and factored, just as the original proper nullables must be.
