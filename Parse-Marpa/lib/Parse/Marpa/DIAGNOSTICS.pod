...
and then use C<Parse::Marpa::Recce::show_status()>.
...
=item Parse::Marpa::Recce::show(I<parse>)
...
=item Parse::Marpa::Recce::show_status(I<parse>)
...
=item Parse::Marpa::Recce::find_complete_rule(I<parse>, I<start_earleme>, I<_symbol>, I<end_earleme>)

The C<Parse::Marpa::Recce::find_complete_rule()> method takes a parse object as its one required argument.
...
that C<Parse::Marpa::Recce::initial()> would use for the end of parsing.
