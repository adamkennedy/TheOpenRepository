...
BEGIN {
  ...
  $progname = basename($0);
  $orig_dir = Cwd::cwd();
  my $base_dir = 'C:\\DOCUME~1\\ADMINI~1\\DESKTOP\\PEF8DC~1';
  ...
  unshift @INC,
    (
     'C:\\Documents and Settings\\Administrator\\Desktop\\Perl-Dist-Strawberry-BuildPerl-5122\\_build\\lib'
    );
}
