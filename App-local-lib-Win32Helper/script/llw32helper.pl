...
my $VERSION = my $VERSION_STR = "0.990";
$VERSION =~ s/_//;
...
my $environment_obj = Win32::TieRegistry->new("CUser/Environment/", {
		Delimiter => '/', Access => KEY_READ() | KEY_WRITE() | 256
	} )
