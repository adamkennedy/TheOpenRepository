...
sub import {
	...
	$params->{url}    ||= 'http://svn.ali.as/db/cpandb.sqlite.gz';
...
CPANDB - A unified metadata database for the CPAN index
...
This is an experimental L<ORLite> module that provides an ORM class
tree for the L<http://svn.ali.as/db/cpandb.sqlite.gz> unified index
database.

Please excuse the limited POD for the moment, I'll expand it with
more detail later.
...
CPANDB is based on L<ORLite> 1.22 and L<ORLite::Mirror> 1.15.
