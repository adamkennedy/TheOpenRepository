...
Marpa::Doc::Parse_Terms - Standard Parsing Terms used in the Marpa Documents
...
excellent chapter on parsing in the Perl context|Marpa::Doc::Bibliography/"Dominus 2005">.
It's available on-line.
L<Wikipedia|Marpa::Doc::Bibliography/"Wikipedia"> is also an excellent place to start.
...
from any symbol to a string of symbols of length 1, where the one
symbol in the result string is the same as the original symbol.
