...
=end Marpa::Test::Display:
    ...
    Tree Node #1: S6@0-3L0o1[0]; Parent = 0; Depth = 1; Rhs Length = 3
        Rule: e -> e op e .
        Kernel: S5@0-2R0:2o2
        Closure: S4@2-3L0o3
        Perl Closure: Y
    Tree Node #2: S4@2-3L0o3[0]; Parent = 1; Depth = 2; Rhs Length = 1
        Rule: e -> number .
...
=end Marpa::Test::Display:
    ...
    Tree Node #0: S2@0-3L3o0[0]; Depth = 0; Rhs Length = 1
        Rule: e['] -> e .
        Closure: S6@0-3L0o1
        Perl Closure: Y
    Tree Node #1: S6@0-3L0o1[0]; Parent = 0; Depth = 1; Rhs Length = 3
    ...
    Tree Node #2: S4@2-3L0o3[0]; Parent = 1; Depth = 2; Rhs Length = 1
        Rule: e -> number .
        Perl Closure: Y; Token: '2'
    Tree Node #3: S5@0-2R0:2o2[0]; Parent = 1; Depth = 2; Rhs Length = 3
        Rule: e -> e op . e
        Kernel: S3@0-1R0:1o4
        Perl Closure: N; Token: '+'
    Tree Node #4: S3@0-1R0:1o4[0]; Parent = 3; Depth = 3; Rhs Length = 3
        Rule: e -> e . op e
        Closure: S4@0-1L0o5
        Perl Closure: N
    Tree Node #5: S4@0-1L0o5[0]; Parent = 4; Depth = 4; Rhs Length = 1
        Rule: e -> number .
        Perl Closure: Y; Token: '2'
