...
First, parse bocages may contain cycles.
Second, and-nodes and or-nodes strictly alternate in a parse bocage.
That is, every direct child of an and-node is an or-node,
and every direct child of an or-node is an and-node.
Third,
and-nodes in a parse bocage have at most two rhs symbols.
...
An and-node is always a child of exactly one or-node.
...
=end Marpa::Test::Display:
    ...
    S5@0-2R0:2o2 -> S5@0-2R0:2o2a2
    S5@0-2R0:2o2a2 -> S3@0-1R0:1o4 '+'
        rule 0: e -> e op . e
...
B<Parse trees have been elminated.  The following
needs to be rewritten.>

Marpa evaluates using an evaluation stack,
which is initialized to empty.
Every time Marpa evaluates a node,
it pushes the result onto the evaluation stack.
If a node needs values as input,
...
=end Marpa::Test::Display:
    ...
    Popping 1 values to evaluate S4@2-3L0o3a3, rule: 1: e -> number
    Calculated and pushed value: '2==2'
    Popping 3 values to evaluate S6@0-3L0o1a1, rule: 0: e -> e op e
...
Z<>
    ...
    100: production-paragraph ->
        non-structural-production-sentences
        production-sentence
        production-paragraph[R11:2][x5f] /* vrhs real=2 */
...
Z<>
    ...
    104: production-paragraph[R11:2][x5f] ->
        non-structural-production-sentences
        production-paragraph[R11:3][x60] /* vlhs vrhs real=1 */
...
Z<>
    ...
    107: production-paragraph[R11:3][x60] ->
        action-sentence:optional
        non-structural-production-sentences /* vlhs real=2 */
    108: production-paragraph[R11:3][x60] ->
        action-sentence:optional
        non-structural-production-sentences[] /* vlhs real=2 */
    109: production-paragraph[R11:3][x60] ->
        action-sentence:optional[]
        non-structural-production-sentences /* vlhs real=2 */
...
B<THE FOLLOWING DISPLAY NEEDS TO CHANGE SO THAT IT NO
LONGER USES MDL.>
...
=end Marpa::Test::Display:
    ...
    S2@0-3L3o0a0 -> S6@0-3L0o1
        rule 2: e['] -> e .
    S6@0-3L0o1 -> S6@0-3L0o1a1
    S6@0-3L0o1a1 -> S5@0-2R0:2o2 S4@2-3L0o3
        rule 0: e -> e op e .
    S5@0-2R0:2o2 -> S5@0-2R0:2o2a2
    S5@0-2R0:2o2a2 -> S3@0-1R0:1o4 '+'
        rule 0: e -> e op . e
    S4@2-3L0o3 -> S4@2-3L0o3a3
    S4@2-3L0o3a3 -> '2'
        rule 1: e -> number .
    S3@0-1R0:1o4 -> S3@0-1R0:1o4a4
    S3@0-1R0:1o4a4 -> S4@0-1L0o5
        rule 0: e -> e . op e
    S4@0-1L0o5 -> S4@0-1L0o5a5
    S4@0-1L0o5a5 -> '2'
        rule 1: e -> number .
...
=end Marpa::Test::Display:
    ...
    Pushed value from S4@0-1L0o5a5: '2'
    Popping 1 values to evaluate S4@0-1L0o5a5, rule: 1: e -> number
    Calculated and pushed value: '2==2'
    Pushed value from S5@0-2R0:2o2a2: '+'
    Pushed value from S4@2-3L0o3a3: '2'
    Popping 1 values to evaluate S4@2-3L0o3a3, rule: 1: e -> number
    Calculated and pushed value: '2==2'
    Popping 3 values to evaluate S6@0-3L0o1a1, rule: 0: e -> e op e
    Calculated and pushed value: '(2+2)==4'
    New Virtual Rule: S2@0-3L3o0a0, rule: 2: e['] -> e
