...
=end Marpa::Test::Display:
    ...
    if ( $fail_location >= 0 ) {
        ...
        or croak "print to STDERR failed: $OS_ERROR";
        exit 1;
    }
...
=end Marpa::Test::Display:
    ...
    print Marpa::show_problems($grammar)
        or croak "print failed: $OS_ERROR";
...
=end Marpa::Test::Display:
    ...
    print Marpa::show_rules($grammar)
        or croak "print failed: $OS_ERROR";
...
=end Marpa::Test::Display:
    ...
    print Marpa::show_symbols($grammar)
        or croak "print failed: $OS_ERROR";
...
=end Marpa::Test::Display:
    ...
    for my $symbol ( @{ Marpa::unproductive_symbols($grammar) } ) {
...
=end Marpa::Test::Display:
    ...
    print Marpa::show_earley_sets($recce)
        or croak "print failed: $OS_ERROR";
...
=end Marpa::Test::Display:
    ...
    print Marpa::show_bocage($evaler, $show_bocage_verbosity)
        or croak "print failed: $OS_ERROR";
...
=end Marpa::Test::Display:
    ...
    print Marpa::show_tree($evaler, $show_tree_flag)
        or croak "print failed: $OS_ERROR";
