...
Marpa::Doc::Undocumented - Fragments Describing Undocumented Features
...
Someday nodes in Marpa may have no value.
Right now 
special options to create evaluators of user specified
...
=head2 Marpa::Recognizer::find_complete_rule
...
which are described in L<their own document|Marpa::Doc::Internals>.
...
in methods for improved diagnostics
