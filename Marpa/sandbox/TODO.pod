...
Remove the PACKAGE field once I have done so.

=item * I've disabled the preambles.
Remove lex and regular preamble code.

=item * Remove legacy code to allow actions specified as Perl5 code.
...
=item * Remove code_diag.t tests for string closures.

=item * Remove INITIAL_ACTION, FINAL_ACTION.
