package Perl::Dist::Strawberry::BuildPerl::5121;

=pod

=begin readme text

Perl::Dist::Strawberry::BuildPerl::5121 version 2.11_10
...
Perl::Dist::Strawberry::BuildPerl::5121 - Files and code for building Perl 5.12.1

=head1 VERSION

This document describes Perl::Dist::Strawberry::BuildPerl::5121 version 2.11_10.
...
around '_find_perl_file' => sub {
	...
	$location = eval { 
		File::ShareDir::module_file('Perl::Dist::Strawberry::BuildPerl::5121', $file);
	};
