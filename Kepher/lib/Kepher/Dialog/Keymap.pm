...
sub keymap {
	...
	if ( !$PCE::internal{'keymap'}{'dialog_active'}
		|| $PCE::internal{'keymap'}{'dialog_active'} == 0 ) {

		# init win mit grunddesign
		$PCE::internal{'keymap'}{'dialog_active'} = 1;
		my $keymap_win = Wx::Frame->new(
			$frame,
			-1,
			' ' . $PCE::localisation{'dialogs'}{'keyboard_map'}{'title'},
			[ 10,  10 ],
			[ 420, 460 ],
		...
		PCE::App::Window::load_icon( $keymap_win,
