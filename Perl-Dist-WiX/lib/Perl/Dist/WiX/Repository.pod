...
branches that are currently being used as of September 2009.
...
you're planning to do, so that I don't accidentally step on your changes.

You may wish to work on your own branch, and then communicate with me to get it 
merged into the trunk, by doing:
...
This has been completed, and changes from the "Vendorperl" branch below are 
...
Location: L<http://svn.ali.as/cpan/branches/Perl-Dist-WiX/vendorperl2/>)

This is the current "work" branch" and includes code for having modules 
provided by Strawberry Perl install into a "vendor" directory, instead 
of using the "site" directories.

This code will be incorporated into the trunk soon.
