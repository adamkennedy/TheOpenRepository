...
SCOPE: {
	...
	is( $object->foo, 'bar', 'after_throwing changing return_value' );
...
SCOPE: {
	...
	is( $object->inc(2), 3, 'after_throwing advice changing params does nothing' );
...
SCOPE: {
	...
	is( $object->inc(2), 6, 'after_throwing advice changing params' );
