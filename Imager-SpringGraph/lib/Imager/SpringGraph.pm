...
=head1 SYNOPSIS
  ...
  use Imager::SpringGraph qw(calculate_graph draw_graph);
  
  my $graph = new Imager::SpringGraph;
...
The goal of this module is to provide a compatible interface to VCG and/or
GraphViz perl modules on CPAN. This module will also provide some extra
features to provide more flexibility and power.
