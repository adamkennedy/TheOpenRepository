...
=head2 base
  ...
  my $namespace = ORDB::AU::Census2006::BcpCdB37->base;
...
=head2 table
  ...
  # Returns 'bcp_cd_b37'
  print ORDB::AU::Census2006::BcpCdB37->table;
...
=head2 load
  ...
  my $object = ORDB::AU::Census2006::BcpCdB37->load( $region_id );
...
It returns a C<ORDB::AU::Census2006::BcpCdB37> object, or throws an exception if the
...
=head2 iterate
  ...
  ORDB::AU::Census2006::BcpCdB37->iterate( sub {
      print $_->region_id . "\n";
  } );
...
following, except with an O(1) memory cost instead of O(n).
  ...
  foreach ( ORDB::AU::Census2006::BcpCdB37->select ) {
      print $_->region_id . "\n";
  }

You can filter the list via SQL in the same way you can with C<select>.

  ORDB::AU::Census2006::BcpCdB37->iterate(
      'order by ?', 'region_id',
      sub {
          print $_->region_id . "\n";
      }
...
references when used in this form.
  ...
  ORDB::AU::Census2006->iterate(
      'select name from bcp_cd_b37 order by region_id',
      sub {
          print $_->[0] . "\n";
      }
  );
