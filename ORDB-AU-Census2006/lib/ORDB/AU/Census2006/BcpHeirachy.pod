...
=head2 base
  ...
  my $namespace = ORDB::AU::Census2006::BcpHeirachy->base;
...
=head2 table
  ...
  # Returns 'bcp_heirachy'
  print ORDB::AU::Census2006::BcpHeirachy->table;
...
=head2 load
  ...
  my $object = ORDB::AU::Census2006::BcpHeirachy->load( $cd );
...
It returns a C<ORDB::AU::Census2006::BcpHeirachy> object, or throws an exception if the
...
=head2 iterate
  ...
  ORDB::AU::Census2006::BcpHeirachy->iterate( sub {
      print $_->cd . "\n";
  } );
...
following, except with an O(1) memory cost instead of O(n).
  ...
  foreach ( ORDB::AU::Census2006::BcpHeirachy->select ) {
      print $_->cd . "\n";
  }

You can filter the list via SQL in the same way you can with C<select>.

  ORDB::AU::Census2006::BcpHeirachy->iterate(
      'order by ?', 'cd',
      sub {
          print $_->cd . "\n";
      }
...
references when used in this form.
  ...
  ORDB::AU::Census2006->iterate(
      'select name from bcp_heirachy order by cd',
      sub {
          print $_->[0] . "\n";
      }
  );
...
following SQL command.
  ...
  CREATE TABLE bcp_heirachy (
      cd INTEGER NOT NULL PRIMARY KEY,
      ste INTEGER NOT NULL,
