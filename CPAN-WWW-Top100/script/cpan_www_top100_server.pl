...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{CPAN_WWW_TOP100_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{CPAN_WWW_TOP100_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
cpan_www_top100_server.pl - Catalyst Testserver

=head1 SYNOPSIS

cpan_www_top100_server.pl [options]
