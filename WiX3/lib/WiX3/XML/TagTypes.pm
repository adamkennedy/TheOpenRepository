...
subtype InstallExecuteSequenceTag, as class_type 'WiX3::XML::InstallExecuteSequence';
...
subtype ComponentChildTag, as EnvironmentTag | FileTag | RegistryKeyTag | RegistryValueTag | RemoveFolderTag | ShortcutTag;
...
subtype FeatureChildTag, as ComponentTag | ComponentRefTag | FeatureTag | FeatureRefTag | MergeRefTag;
subtype FeatureRefChildTag, as ComponentTag | ComponentRefTag | FeatureTag | FeatureRefTag | MergeRefTag;
