...
Perl::Dist::WiX::BuildPerl::5124 version 1.0
...
Perl::Dist::WiX::BuildPerl::5124 - Files and code for building Perl 5.12.4

=head1 VERSION

This document describes Perl::Dist::WiX::BuildPerl::5124 version 1.0.
...
order to build Perl 5.12.4 itself.  
...
around '_build_library_information' => sub {
	...
	if (32 == $self->bits()) {
		...
		$libraries = {
			...
			'gcc-toolchain' => 'kmx/64_gcctoolchain/mingw64-w64-gcc4.4.7(pre)_20111014.zip',
			'gcc-license'   => 'kmx/64_gcctoolchain/mingw64-w64-gcc4.4.7(pre)_20111014-lic.zip',
...
around '_find_perl_file' => sub {
	...
	$location = eval {
		File::ShareDir::module_file( 'Perl::Dist::WiX::BuildPerl::5124', #FIX on version bump
			"default/$file" );
	};
