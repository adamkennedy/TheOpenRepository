...
EVE::Trade - An ORLite-based ORM Database API
...
=head2 pragma
  ...
  my $version = EVE::Trade->pragma('user_version');
...
B<EVE::Trade> is based on L<ORLite>.
