...
use ORLite::Migrate {
	...
	file   => File::Spec->catfile(
		...
		File::Spec->isa('File::Spec::Win32') ? 'Perl' : '.perl',
		'ADAMK-Repository',
		'cache.sqlite',
	),
	timeline => File::Spec->catdir(
		File::ShareDir::dist_dir('ADAMK-Repository'),
		'timeline',
	),
	user_version => 1,
};
...
ADAMK::Cache - An ORLite-based ORM Database API
...
ADAMK::Cache is based on L<ORLite> 1.20.
