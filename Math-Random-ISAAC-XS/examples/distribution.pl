...
This script plots the distribution of data generated by ISAAC. It first
uses Statistics::Test::RandomWalk to collect all of the output, then
display it in a graphical format. It's a pretty simple module but might
eventually make something neat, as the data is being plotted randomly :-)

It outputs a file named chart.png in the current working directory.
