...
*CORE::GLOBAL::caller = sub {
	...
	while (1) {
		...
		$name_cache = $caller[0] =~ /^Hook::LexWrap\b/ ? $caller[3] : '';
...
Hook::LexWrap::Compat - Back-compatible lexically scoped subroutine wrappers

=head1 SYNOPSIS

	use Hook::LexWrap::Compat;
...
Hook::LexWrap has a stated minimum Perl version of  allows you to install a pre- or post-wrapper (or both)
