...
ksh=''
ld='g++'
lddlflags='-mdll -s -L"$prefix\lib\CORE" -L"$root\c\lib"'
ldflags='-s -L"$prefix\lib\CORE" -L"$root\c\lib"'
...
ldflags_nolargefiles='-s -L"$prefix\lib\CORE" -L"$root\c\lib"'
...
EOVIRTUAL
$Config_SH_expanded =~ s/\$perlpath/$Config::perlpath/g;
$Config_SH_expanded =~ s/\$bin/$Config::bin/g;
$Config_SH_expanded =~ s/\$prefix/$Config::prefix/g;
$Config_SH_expanded =~ s/\$root/$Config::root/g;
