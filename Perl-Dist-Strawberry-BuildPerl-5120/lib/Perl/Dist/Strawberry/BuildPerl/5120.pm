package Perl::Dist::Strawberry::BuildPerl::5120;

=pod

=begin readme text

Perl::Dist::Strawberry::BuildPerl::5120 version 2.11_10
...
This document describes Perl::Dist::Strawberry::BuildPerl::5120 version 2.11_10.
...
around '_find_perl_file' => sub {
	...
	$location = eval { 
		File::ShareDir::module_file('Perl::Dist::Strawberry::BuildPerl::5120', $file);
	};
