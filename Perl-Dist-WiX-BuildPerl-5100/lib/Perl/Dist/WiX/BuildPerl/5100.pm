package Perl::Dist::WiX::BuildPerl::5100;

=pod

=begin readme text

Perl::Dist::WiX::BuildPerl::5100 version 1.250_100
...
Perl::Dist::WiX::BuildPerl::5100 - Files and code for building Perl 5.10.0

=head1 VERSION

This document describes Perl::Dist::WiX::BuildPerl::5100 version 1.250_100.
...
order to build Perl 5.10.0 itself.  
...
around '_find_perl_file' => sub {
	...
	$location = eval { 
		File::ShareDir::module_file('Perl::Dist::WiX::BuildPerl::5100', "default/$file");
	};
