package Perl::Dist::WiX::BuildPerl::5122;

=pod

=begin readme text

Perl::Dist::WiX::BuildPerl::5122 version 1.250_100
...
Perl::Dist::WiX::BuildPerl::5122 - Files and code for building Perl 5.12.2

=head1 VERSION

This document describes Perl::Dist::WiX::BuildPerl::5122 version 1.250_100.
...
order to build Perl 5.12.2 itself.  
...
around '_install_perl_plugin' => sub {
	...
	my $perl = Perl::Dist::WiX::Asset::Perl->new(
		parent    => $self,
		url       => 'http://search.cpan.org/CPAN/authors/id/J/JE/JESSE/perl-5.12.2.tar.bz2',
		toolchain => $toolchain,
		patch     => [ qw{
			  lib/CPAN/Config.pm
			  win32/config.gc
		...
		license => {
			'perl-5.12.2/Readme'   => 'perl/Readme',
			'perl-5.12.2/Artistic' => 'perl/Artistic',
			'perl-5.12.2/Copying'  => 'perl/Copying',
		},
	);
	$perl->install();
