...
BEGIN {
  ...
  $progname = basename($0);
  $orig_dir = Cwd::cwd();
  my $base_dir = 'C:\\DOCUME~1\\ADMINI~1\\DESKTOP\\PE1E3D~1';
  ...
  unshift @INC,
    (
     'C:\\Documents and Settings\\Administrator\\Desktop\\Perl-Dist-WiX-BuildPerl-5122\\_build\\lib'
    );
}
